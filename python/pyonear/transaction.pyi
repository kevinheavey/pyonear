...
class DeployContractAction:
    __hash__: ClassVar[None]  # type: ignore
    code: List[int]
    def __init__(self, code: Sequence[int]) -> None: ...
    @staticmethod
...
class FunctionCallAction:
    ...
    method_name: str
    def __init__(
        self, method_name: str, args: Sequence[int], gas: int, deposit: int
    ) -> None: ...
    @staticmethod
...
class Transaction:
    ...
    def add_key(self, public_key: PublicKey, access_key: AccessKey) -> "Transaction": ...
    ...
    def deploy_contract(self, code: Sequence[int]) -> "Transaction": ...
    def function_call(self,method_name: str,
        args: Sequence[int],
        gas: int,
